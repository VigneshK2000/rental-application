...
export const getProperties = async (
  ...
  try {
    ...
    // Build the respone we want by joining the property and location tables and filtering by the array of whereConditions
...
export const createProperty = async (
  ...
  try {
    ...
    const geocodingResponse = await axios.get(geocodingurl, {
      headers: {
        "User-Agent": "RealEstateApp (viggyk33@gmail.com)",
      },
    });
